    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if sum(results_dic[key][3:]) == 1:
                print("{:>26}{:>30}".format(results_dic[key][0],results_dic[key][1]))
            """if results_dic[key][3] == 1 and results_dic[key][4] == 0:
                print(f"Pet label is a dog but classified as NOT-a-dog: {results_dic[key][0]} vs {results_dic[key][1]}")
            elif results_dic[key][3] == 0 and results_dic[key][4] == 1:
                print(f"Pet label is NOT-a-dog but classified as a dog: {results_dic[key][0]} vs {results_dic[key][1]}") """   
